...
function BindRegionsList() {
    var url = "/GlobalAdmin/RegionsMaster/GetAllRegions";
...
function DeleteRegions(id) {
    $.ajax({
        url: "/GlobalAdmin/RegionsMaster/DeleteRegion?RegionID=" + id,
...
function EditAcademyTeamById(Id) {
    ...
    $.ajax({
        url: "/GlobalAdmin/RegionsMaster/GetRegionById?Id=" + Id,
        type: 'get',
        success: function (result) {
            if (result != false) {
...
function UpdateAcademyTeamById() {
    if (validate()) {
        ...
        $.ajax({
            url: "/GlobalAdmin/RegionsMaster/InsertUpdateRegion",
            type: 'POST',
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
