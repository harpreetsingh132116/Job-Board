...
function DeleteUser(id) {
    $.ajax({
        url: "/SuperAdmin/ManageUsers/DeleteUser?userid=" + id,
...
function BindUsersList() {
    var url = "/SuperAdmin/ManageUsers/GetAllUsers";
...
function EditAcademyTeamById(Id) {
    ...
    $.ajax({
        url: "/SuperAdmin/ManageUsers/GetUserById?Id=" + Id,
        type: 'get',
        success: function (result) {
            if (result != false) {
...
function UpdateAcademyTeamById() {
    ...
    if (validate()) {
        ...
        $.ajax({
            url: "/SuperAdmin/ManageUsers/InsertUpdateUser",
            type: 'POST',
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
