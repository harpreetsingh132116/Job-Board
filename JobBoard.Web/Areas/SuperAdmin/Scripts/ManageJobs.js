...
function BindRegions() {
    $.ajax({
        url: "/SuperAdmin/RegionsMaster/GetAllRegions",
        type: 'get',
...
function BindTrainings() {
    ...
    $.ajax({
        url: "/SuperAdmin/Trainings/GetAllTrainings",
        type: 'get',
        success: function (result) {
            if (result != false) {
...
function BindJobsList() {
    var url = "/SuperAdmin/ManageJobs/GetAllJobs";
...
function DeleteJob(id) {
    $.ajax({
        url: "/SuperAdmin/ManageJobs/DeleteJob?Id=" + id,
...
function EditAcademyTeamById(Id) {
    clearControls();
    $.ajax({
        url: "/SuperAdmin/ManageJobs/GetJobById?jobId=" + Id,
        type: 'get',
        success: function (result) {
            if (result != false) {
                $('[id$=hdnJobId]').val(result.ID);
...
function UpdateAcademyTeamById() {
    ...
    if (validate()) {
        ...
        $.ajax({
            url: "/SuperAdmin/ManageJobs/InsertUpdateJobs",
            type: 'POST',
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
