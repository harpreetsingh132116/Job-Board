...
function BindTrainingsList() {
    var url = "/SuperAdmin/Trainings/GetAllTrainings";
...
function DeleteTraining(id) {
    $.ajax({
        url: "/SuperAdmin/Trainings/DeleteTraining?trainingId=" + id,
...
function EditAcademyTeamById(Id) {
    clearControls();
    $.ajax({
        url: "/SuperAdmin/Trainings/GetTrainingsById?Id=" + Id,
        type: 'get',
        success: function (result) {
            if (result != false) {
...
function UpdateAcademyTeamById() {
    ...
    if (validate()) {
        ...
        $.ajax({
            url: "/SuperAdmin/Trainings/InsertUpdateTrainings",
            type: 'POST',
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
