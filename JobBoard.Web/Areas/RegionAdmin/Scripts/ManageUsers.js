...
function DeleteUser(id) {
    $.ajax({
        url: "/RegionAdmin/ManageUsers/DeleteUser?userid=" + id,
...
function BindUsersList() {
    var url = "/RegionAdmin/ManageUsers/GetAllUsers";
...
function EditAcademyTeamById(Id) {
    ...
    $.ajax({
        url: "/RegionAdmin/ManageUsers/GetUserById?Id=" + Id,
        type: 'get',
        success: function (result) {
            if (result != false) {
...
function UpdateAcademyTeamById() {
    if (validate()) {
        ...
        $.ajax({
            url: "/RegionAdmin/ManageUsers/InsertUpdateUser",
            type: 'POST',
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function BindRolls() {
    $.ajax({
        url: "/RegionAdmin/UserRoles/GetAllUserRoles",
        type: 'get',
        success: function (result) {
            if (result != false) {
                $('#checkboxrolls').empty();
