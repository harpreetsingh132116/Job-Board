...
function BindTrainingsList() {
    var url = "/RegionAdmin/Trainings/GetAllTrainings";
...
function DeleteTraining(id) {
    $.ajax({
        url: "/RegionAdmin/Trainings/DeleteTraining?trainingId=" + id,
...
function EditAcademyTeamById(Id) {
    clearControls();
    $.ajax({
        url: "/RegionAdmin/Trainings/GetTrainingsById?Id=" + Id,
        type: 'get',
        success: function (result) {
            if (result != false) {
...
function UpdateAcademyTeamById() {
    ...
    if (validate()) {
        ...
        $.ajax({
            url: "/RegionAdmin/Trainings/InsertUpdateTrainings",
            type: 'POST',
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
