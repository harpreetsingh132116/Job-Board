...
namespace JobPortal.Areas.RegionAdmin.Controllers
{
    public class ManageJobsController : Controller
    {
        ...
        public ManageJobsController(IBALRegions IBALRegions, BAL.Abstraction.IBALJobs balService,
            IBALJobTimeMapping iBALJobTimeMapping
